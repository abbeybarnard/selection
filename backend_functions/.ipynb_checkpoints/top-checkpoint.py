...
def parameters(ISRUN3): 
   ...
   # FHC
    if not ISRUN3: 
        ...
        # Katrina's original path: plots_path = "/uboone/data/users/kmiller/uBNuMI_CCNp/plots/fhc/"
        
        plots_path = "/exp/uboone/app/users/abarnard/katrina_analysis/code/uBNuMI_CC1eNp/plots/fhc"
    ...
    # RHC 
        ...
        # Katrina's original path: plots_path = "/uboone/data/users/kmiller/uBNuMI_CCNp/plots/rhc/"
        
        plots_path = "/exp/uboone/app/users/abarnard/katrina_analysis/code/uBNuMI_CC1eNp/plots/rhc"
